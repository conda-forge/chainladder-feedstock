...
pixi add chainladder
# for installing globally
pixi global install chainladder
```
...
It is possible to list all of the versions of `chainladder` available on your platform:
...
```
pixi search chainladder --channel conda-forge
```
